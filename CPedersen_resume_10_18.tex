...
\item Back end web developement using PHP, SQL, and Laravel
\item Designed a database for handling all match information and a program to read data from google sheets to an SQL database for use on the site
...
\item Primary tutor in the library for all undergraduate physics for one semester.
